...
const categoryImages: Record<string, string> = {
  'digital-detox': 'https://source.unsplash.com/random/600x400/?digital,minimal',
  ...
  'social-media-detox': 'https://source.unsplash.com/random/600x400/?social,media',
  'health-wellness': 'https://source.unsplash.com/random/600x400/?health,yoga',
  'social-connection': 'https://source.unsplash.com/random/600x400/?connection,people',
  ...
  'lifestyle-challenges': 'https://source.unsplash.com/random/600x400/?lifestyle,challenge',
};
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {category.description || `Explore articles about ${category.name} for a balanced digital lifestyle.`}
        </Typography>
