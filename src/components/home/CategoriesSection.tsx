    ...
    >
      ...
      <Container maxWidth="xl">
        ...
        >
          ...
          >
            Browse our content collections organized by topic to find exactly
            what you're looking for. From digital mindfulness to tech-life
            balance, we cover it all.
          </Typography>
        </Box>
        ...
        <Box
          ...
          sx={{
            ...
            "&::before": {
              ...
              bottom: 0,
              background:
                "linear-gradient(45deg, rgba(216, 180, 254, 0.2), rgba(245, 208, 254, 0.1), rgba(167, 139, 250, 0.2))",
              zIndex: -1,
              opacity: 0.6,
