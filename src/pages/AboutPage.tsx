...
const AboutPage = () => {
  ...
  return (
    <Layout>
      <Seo
        title="About UnplugWell - Our Mission and Team"
        description="Learn about UnplugWell's mission to help people achieve a balanced relationship with technology through mindful digital habits and wellbeing practices."
        canonicalUrl="/about"
      />
        ...
        <Grid container spacing={5} sx={{ mb: 8 }}>
          ...
          >
            ...
            <Typography variant="body1" paragraph>
              At UnplugWell, we believe technology should enhance our lives, not control them. Founded in 2023, our mission is to help people develop a healthier relationship with their digital devices through mindful practices, expert insights, and practical strategies.
            </Typography>
            <Typography variant="body1" paragraph>
              In today's hyper-connected world, finding moments to disconnect has become increasingly challenging yet vital for our mental wellbeing, productivity, and relationships. We provide resources to help you regain control over your digital habits and create space for what truly matters.
            </Typography>
            <Typography variant="body1">
              Whether you're looking to reduce screen time, combat digital burnout, or simply find more balance in your tech use, UnplugWell offers guidance without judgment. We celebrate the benefits of technology while advocating for mindful consumption and regular digital breaks.
            </Typography>
          </Grid>
