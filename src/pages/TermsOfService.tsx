    ...
    <Container sx={{ py: 4 }}>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography paragraph>
          By accessing and using UnplugWell.com (hereinafter referred to as "the
          Site," "we," "us," or "our"), you agree to comply with and be bound by
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography paragraph>
          All content on UnplugWell.com, including but not limited to text,
          images, graphics, logos, and software, is the property of
          UnplugWell.com or its licensors and is protected by copyright and
        ...
        <Typography paragraph>
          ...
          non-commercial purposes only. You may not reproduce, distribute,
        ...
        <Typography paragraph>
          If you submit comments or other user-generated content, you grant us a
          non-exclusive, royalty-free, perpetual, and worldwide license to use,
          reproduce, modify, and distribute that content. You are responsible
          for ensuring your user-generated content does not violate any
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography paragraph>
          When leaving comments, you agree to remain respectful. Any comments
          deemed inappropriate will be removed by UnplugWell.com.
        </Typography>
      </Box>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography paragraph>
          The content on UnplugWell.com is provided for informational purposes
          only and should not be considered professional advice. We make no
          representations or warranties about the accuracy, completeness, or
          suitability of the content.
        </Typography>
        <Typography paragraph>
          We do not guarantee that our Site will be available at all times or
          that it will be free from errors or viruses.
        </Typography>
        <Typography paragraph>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography paragraph>
          ...
          punitive damages arising out of or related to your use of our Site.
        </Typography>
        <Typography paragraph>
          You agree to indemnify and hold UnplugWell.com harmless from any
          claims, damages, or expenses arising out of your use of our Site or
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography paragraph>
          ...
          any changes. Your continued use of our Site after any changes
