...
// Interfaces for speech sections
...
const BlogDetailPage = () => {
  ...
  const extractSpeechSections = () => {
    ...
    const contentElements = contentRef.current.querySelectorAll('h1, h2, h3, h4, h5, h6, p, li, blockquote');
    ...
    contentElements.forEach((element, index) => {
      ...
      else if (currentSection && (tagName === 'p' || tagName === 'li' || tagName === 'blockquote')) {
  ...
  const handleNext = () => {
    ...
    const newIndex = Math.min(speechSections.length - 1, currentSectionIndex + 1);
    ...
    <Layout disableContainer>
      ...
      {isAudioPlayerOpen && (
        <Paper
          ...
          sx={{
            ...
            p: 2,
            borderRadius: 2,
            bgcolor: theme.palette.mode === 'dark' ? 'rgba(30, 41, 59, 0.9)' : 'rgba(255, 255, 255, 0.9)',
            backdropFilter: 'blur(10px)',
            border: '1px solid',
            borderColor: theme.palette.mode === 'dark' ? 'rgba(99, 102, 241, 0.2)' : 'rgba(99, 102, 241, 0.2)',
        ...
        >
          ...
          <Typography variant="subtitle2" noWrap sx={{ mb: 2, fontWeight: 600 }}>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'center', gap: 1, mb: 2 }}>
            ...
            <IconButton 
              onClick={handleNext} 
              disabled={currentSectionIndex >= speechSections.length - 1 || !speechSections.length}
              color="primary"
            >
              <SkipNextIcon />
            </IconButton>
      ...
      <Container maxWidth="xl" sx={{ pt: 4, pb: 8 }}>
        <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: 4 }}>
          ...
          {!isMobile && (tableOfContents.length > 0 || speechSections.length > 0) && (
            <Box
              component={motion.div}
            ...
            >
              ...
              >
                ...
                <Typography variant="subtitle2" sx={{ display: 'flex', alignItems: 'center', mb: 1.5 }}>
                  <HeadsetIcon sx={{ fontSize: 18, mr: 1, color: '#6366f1' }} />
                  Listen to Article
                </Typography>
