    ...
    <Container sx={{ py: 4 }}>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography paragraph>
          Welcome to UnplugWell.com (hereinafter referred to as "the Site,"
          "we," "us," or "our"). We are committed to protecting your privacy and
          ensuring the security of your personal information. This Privacy
          Policy outlines how we collect, use, disclose, and safeguard your
          information when you visit our Site. By using UnplugWell.com, you
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <ul>
          <li>
            <Typography>
              When you subscribe to our newsletter, leave comments, or contact
              us through our contact form, we may collect your name, email
              address, and any other information you voluntarily provide.
            </Typography>
          </li>
          <li>
            <Typography>
              If you create an account (if applicable in the future), we may
              collect your username, password, and profile information.
            </Typography>
          </li>
        </ul>
        ...
        <ul>
          <li>
            <Typography>
              ...
              system, referring website, pages visited, and the dates and times
              of your visits.
            </Typography>
          </li>
          <li>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <ul>
          <li>
            <Typography>To provide and maintain our Site.</Typography>
          </li>
          <li>
            <Typography>
          ...
          <li>
            <Typography>To respond to your comments and inquiries.</Typography>
          </li>
          <li>
            <Typography>To improve our Site and user experience.</Typography>
          </li>
          <li>
            <Typography>
        ...
        <ul>
          <li>
            <Typography>
              ...
              your device that allow us to recognize your browser and remember
              certain information.
            </Typography>
          </li>
          <li>
            <Typography>
              You can control cookies through your browser settings and opt-out
              of certain tracking technologies. However, disabling cookies may
